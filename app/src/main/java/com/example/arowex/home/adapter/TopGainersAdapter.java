...
public class TopGainersAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<TopGainerResonse> items;
    private Context context;

    public TopGainersAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.top_gainers_item, parent, false);
