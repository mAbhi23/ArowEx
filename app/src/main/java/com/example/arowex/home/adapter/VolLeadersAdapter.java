...
public class VolLeadersAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<TopGainerResonse> items;
    private Context context;

    public VolLeadersAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.vol_leaders_item, parent, false);
